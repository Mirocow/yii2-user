...
class User extends ActiveRecord implements IdentityInterface {
     ...
     * @return int
     */
    public function sendEmailConfirmation($session, $subject = '', $emailView = '', $emailViewPath = '', $params = []) {

        // modify view path to module views
        /** @var Mailer $mailer */
        $mailer = Yii::$app->mail;

        $mailer->viewPath = $emailViewPath? $emailViewPath: Yii::$app->getModule("user")->emailViewPath;
        ...
        $subject = $subject? $subject: Yii::$app->id . " - Email confirmation";

        $site = Yii::$app->name;

        $from = isset(Yii::$app->params['adminEmail'])? Yii::$app->params['adminEmail']: 'admin@localhost';

        $params = array_merge($params, compact("subject", "user", "profile", "session", "site"));
    ...
    * 
    * @param mixed $role_name - Maybe string or array
    */
